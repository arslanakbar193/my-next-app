      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100 p-0">
        <div className="w-full bg-white shadow-lg rounded-lg">
          <div className="grid grid-cols-1 md:grid-cols-2 w-full min-h-screen">
            ...
            >
              <div className="bg-white p-8 md:p-4 rounded shadow-md text-center w-[70%] h-[75%] md:w-[90%] lg:w-[70%] animate__animated animate__fadeInRight">
                <div className="w-full bg-white flex items-center justify-center p-10 md:p-4 h-[100%]">
